...
public class LogfileHealthCheck : IHealthCheck
{
        ...
        CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        {
            return Task.FromResult(HealthCheckResult.Healthy("Log files do exist."));
        }

        return Task.FromResult(HealthCheckResult.Degraded("No log files found. Missing write permission?"));
    }
}

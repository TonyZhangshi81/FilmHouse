...
namespace FilmHouse.Data.Core.ValueObjects
{
    ...
    public partial class DirectorNamesVO : FilmHouse.Core.ValueObjects.TextBase, IEquatable<DirectorNamesVO>, IComparable<DirectorNamesVO>, IValue<string>, IValueObject
    {

...
namespace FilmHouse.Data.Core.ValueObjects
{
    ...
    public partial class AlbumJsonItemsVO : FilmHouse.Core.ValueObjects.TextBase, IEquatable<AlbumJsonItemsVO>, IComparable<AlbumJsonItemsVO>, IValue<string>, IValueObject
    {

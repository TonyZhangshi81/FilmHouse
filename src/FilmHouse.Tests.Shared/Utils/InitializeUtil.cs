...
namespace FilmHouse.Tests.Utils;

public static class InitializeUtil
{
    public static IServiceScope SetupServiceScope(Action<IServiceCollection> setupServicesAction = null)
    {

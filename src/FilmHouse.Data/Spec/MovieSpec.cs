...
{
    public MovieSpec(int pageSize, int pageIndex, ReviewStatusVO reviewStatus) : base(c => c.ReviewStatus == reviewStatus)
    {
    ...
    public MovieSpec(MovieIdVO[] ids) : base(c => ids.Contains(c.MovieId))
    {
    }

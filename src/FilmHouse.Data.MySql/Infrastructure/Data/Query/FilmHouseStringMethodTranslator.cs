...
#pragma warning disable EF1001 // Internal EF Core API usage.
    public class FilmHouseStringMethodTranslator : MySqlStringMethodTranslator
    {
        ...
        public FilmHouseStringMethodTranslator(MySqlSqlExpressionFactory sqlExpressionFactory, MySqlTypeMappingSource typeMappingSource, IMySqlOptions options)
            : base(sqlExpressionFactory, typeMappingSource, options)
        {

...
namespace FilmHouse.Core.ValueObjects
{
    ...
    public partial class CountriesVO : FilmHouse.Core.ValueObjects.CodesId, IEquatable<CountriesVO>, IComparable<CountriesVO>, IValue<string>, IValueObject, IEnumeratorObject<CodeKeyVO>
    {

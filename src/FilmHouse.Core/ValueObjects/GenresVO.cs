...
namespace FilmHouse.Core.ValueObjects
{
    ...
    public partial class GenresVO : FilmHouse.Core.ValueObjects.CodesId, IEquatable<GenresVO>, IComparable<GenresVO>, IValue<string>, IValueObject, IEnumeratorObject<CodeKeyVO>
    {

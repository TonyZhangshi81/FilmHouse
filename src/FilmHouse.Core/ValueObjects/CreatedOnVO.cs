...
namespace FilmHouse.Core.ValueObjects
{
    ...
    public partial class CreatedOnVO : FilmHouse.Core.ValueObjects.DateTimeValueObjectBase, IEquatable<CreatedOnVO>, IComparable<CreatedOnVO>, IValue<System.DateTime>, IValueObject
    {

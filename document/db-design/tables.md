...
### 6. **[Country 制片国家/地区](#jump_Country)** (已经废弃 -> CODE管理表)
### 7. **[GenreMovie 电影类型](#jump_GenreMovie)** (已经废弃 -> CODE管理表)
### 8. **[Language 语言](#jump_Language)** (已经废弃 -> CODE管理表)
...
| :-------------- | :------: | ---: | ---: | ---: | ---: | --: | -----: | :--------------------------------------------------------------------- |
| album_AlbumId        | varchar  |   50 |      |      |    v |   v |        | 主键                                                                   |
| album_Title     | nvarchar |   50 |      |      |    v |     |        | 影集名称                                                               |
| album_User      | varchar  |   50 |      |      |    v |     |        | 登录者ID（与 UserAccount.user_Id 有外键关系）                      |
| album_Item      | nvarchar |   -1 |      |      |      |     |        | 电影对象（以json格式保存的电影集合，与 Movie.movie_Id 有外键关系） |
...
| 列明      |   类型   | 长度 | 标度 | 精度 | 非空 |  PK | 默认值 | 业务描述                                          |
| :-------- | :------: | ---: | ---: | ---: | ---: | --: | -----: | :------------------------------------------------ |
| ask_AskId    | varchar  |   50 |      |      |    v |   v |        | 主键                                              |
| ask_User  | varchar  |   50 |      |      |    v |     |        | 登录者ID（与 UserAccount.user_Id 有外键关系） |
| ask_Movie | varchar  |   50 |      |      |    v |     |        | 电影ID（与 Movie.movie_Id 有外键关系）        |
...
| 列明            |   类型   | 长度 | 标度 | 精度 | 非空 |  PK | 默认值 | 业务描述                                          |
| :-------------- | :------: | ---: | ---: | ---: | ---: | --: | -----: | :------------------------------------------------ |
| celeb_CelebrityId | varchar  |   50 |      |      |    v |   v |        | 主键                                              |
...
| celeb_Create    | varchar  |   50 |      |      |      |     |        | 登录者ID（与 UserAccount.user_Id 有外键关系） |
...
| 列明        |   类型   | 长度 | 标度 | 精度 | 非空 |  PK | 默认值 | 业务描述                                          |
| :---------- | :------: | ---: | ---: | ---: | ---: | --: | -----: | :------------------------------------------------ |
| cmt_CommentId | varchar  |   50 |      |      |    v |   v |        | 主键                                              |
| cmt_Content | nvarchar |   -1 |      |      |    v |     |        | 内容                                              |
| cmt_User    | varchar  |   50 |      |      |      |     |        | 登录者ID（与 UserAccount.user_Id 有外键关系） |
| cmt_Movie   | varchar  |   50 |      |      |    v |     |        | 电影ID（与 Movie.movie_Id 有外键关系）        |
...
| disc_Movie | varchar  |   50 |      |      |    v |     |        | 电影ID（与 Movie.movie_Id 有外键关系） |
...
| movie_Genres      | varchar  |   50 |      |      |      |     |        | 类型列表（必须使用"/"进行分割，与 GenreMovie.genre_Id 有外键关系）       |
| movie_Languages   | varchar  |   50 |      |      |      |     |        | 语言列表（必须使用"/"进行分割，与 Language.lang_Id 有外键关系）          |
| movie_Countries   | varchar  |   50 |      |      |      |     |        | 制片国家/地区列表（必须使用"/"进行分割，与 Country.genre_Id 有外键关系） |
...
| movie_Create      | varchar  |   50 |      |      |      |     |        | 登录者ID（与 UserAccount.user_Id 有外键关系）                            |
...
- 以下列举导演、编剧、演员导航与数据对应关系和使用规则  ***（必须使用"/"进行分割，与Celebrity.ask_Id有外键关系）***
  - 多名演员列表导航
...
#### *** Country、GenreMovie、Language 这三个实体以CodeMast进行管理 ***

<a id="jump_Country"></a>
### [制片国家/地区] Country （*** 已经废弃 ***）
...
| res_User       | varchar  |   50 |      |      |      |     |        | 登录者ID （与 UserAccount.user_Id 有外键关系） |
| res_Movie      | varchar  |   50 |      |      |    v |     |        | 电影ID（与 Movie.movie_Id 有外键关系）         |
...
| mark_User   | varchar  |   50 |      |      |    v |     |        | 登录者ID （与 UserAccount.user_Id 有外键关系）                                    |
...
| notice_User    | varchar  |   50 |      |      |    v |     |        | 登录者ID （与 UserAccount.user_Id 有外键关系） |
...
| work_Movie | varchar |   50 |      |      |    v |     |        | 电影ID（与 Movie.movie_Id 有外键关系）     |
| work_Celeb | varchar |   50 |      |      |    v |     |        | 影人ID（与 Celebrity.celeb_Id 有外键关系） |

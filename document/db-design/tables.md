...
| RequestTime | timestamp |    8 |      |      |     |     |        | 请求时间                                         | RequestTimeVO |
| RequestWith |  numeric  |    4 |    0 |      |     |     |      0 | 被请求的数量                                     | RequestWithVO |
| Note        |  varchar  | 1000 |      |      |     |     |        | 备注                                             | NoteVO        |
| Status      |   bool    |    1 |      |      |     |     |  false | 状态<BR>(1:已求到 0:未求到)                      | StatusVO      |
| CreatedOn   | timestamp |    8 |      |  v   |     |     |        | 创建时间                                         | CreatedOnVO   |
| UpDatedOn   | timestamp |    8 |      |      |     |     |        | 修改时间                                         | UpDatedOnVO   |
...
| CommentTime | timestamp |    8 |      |      |     |     |        | 评论时间                                         | CommentTimeVO |
| CreatedOn   | timestamp |    8 |      |  v   |     |     |        | 创建时间                                         | CreatedOnVO   |
| UpDatedOn   | timestamp |    8 |      |      |     |     |        | 修改时间                                         | UpDatedOnVO   |
...
| Rating       |  numeric  |    4 |    1 |      |     |     |    0.0 | 评分<BR>（0.0 ~ 10.0之间）                                                   | RatingVO       |
...
| ReviewStatus |   int2    |    1 |      |      |     |     |      0 | 状态<BR>（0:默认值 1:评审不通过 2:通过）                                     | ReviewStatusVO |
| Note         |  varchar  | 1000 |      |      |     |     |        | 评审信息<BR>（0:内容有误 1:已经存在 other:其他）                             | NoteVO         |
| PageViews    |  numeric  |   11 |    0 |      |     |     |      0 | 浏览量                                                                       | PageViewsVO    |
| CreatedOn    | timestamp |    8 |      |  v   |     |     |        | 创建时间                                                                     | CreatedOnVO    |
| UpDatedOn    | timestamp |    8 |      |      |     |     |        | 修改时间                                                                     | UpDatedOnVO    |
...
| :-------- | :-------: | ---: | ---: | :--: | :-: | :-: | -----: | :------- | :---------- |
| RequestId |   uuid    |   36 |      |  v   |     |     |        | GUID     | RequestIdVO |
| Group     |  varchar  |   20 |      |  v   |  v  |     |        | 类别     | GroupVO     |
| Code      |  varchar  |   20 |      |  v   |     |     |        | KEY      | CodeVO      |
| Name      |  varchar  |   50 |      |  v   |     |     |        | 值       | NameVO      |
| Order     |  numeric  |    3 |    0 |  v   |     |     |        | 排序顺   | OrderVO     |
| CreatedOn | timestamp |    8 |      |  v   |     |     |        | 创建时间 | CreatedOnVO |
| UpDatedOn | timestamp |    8 |      |      |     |     |        | 修改时间 | UpDatedOnVO |
...
| Type         |   int2    |    1 |      |      |     |     |      0 | 类型<BR>（0:电驴链接 1:磁力链 other:bt种子）     | TypeVO         |
| ReviewStatus |   int4    |    1 |      |      |     |     |      0 | 状态<BR>（0:默认值 1:评审不通过 2:通过）         | ReviewStatusVO |
| Note         |  varchar  | 1000 |      |      |     |     |        | 备注                                             | NoteVO         |
| CreatedOn    | timestamp |    8 |      |  v   |     |     |        | 创建时间                                         | CreatedOnVO    |
| UpDatedOn    | timestamp |    8 |      |      |     |     |        | 修改时间                                         | UpDatedOnVO    |
...
| Type      |   int2    |    3 |      |  v   |     |     |      0 | 标记类型<BR>（0默认值, 1想看电影，2看过电影，3喜欢电影，4收藏影人，5赞资源，6同求资源，7关注专辑） | TypeVO      |
| UserId    |   uuid    |   36 |      |  v   |     |  v  |        | 登录者ID <BR>（与 UserAccount.UserId 有外键关系）                                                  | UserIdVO    |
